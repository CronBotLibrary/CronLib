...
public class CommandClientBuilder
{
    ...
    private final LinkedHashMap<SlashCommand, JavaFeature> slashCommands = new LinkedHashMap<>();
    ...
    public CommandClient build()
    {
        CommandClient client = new CommandClientImpl(ownerId, coOwnerIds, prefix, altprefix, prefixes, prefixFunction, commandPreProcessFunction, commandPreProcessBiFunction, activity, status, serverInvite,
                success, warning, error, carbonKey, botsKey, new ArrayList<>(commands), new HashMap<>(slashCommands), new ArrayList<>(contextMenus), forcedGuildId, manualUpsert, useHelp,
     ...
     * @return This builder
     */
    public CommandClientBuilder addSlashCommand(SlashCommand command, JavaFeature feature)
    {
        slashCommands.put(command, feature);
        return this;
    }
